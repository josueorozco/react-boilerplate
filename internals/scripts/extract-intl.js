/* eslint-disable no-restricted-syntax, prefer-arrow-callback, no-undef */
...
for (const locale of locales) {
    ...
    try {
        ...
        const messages = {};
        Object.keys(localeMappings[locale]).sort().forEach(function mainLocalMappingsForEach(key) {
